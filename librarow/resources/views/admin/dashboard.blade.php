    ...
    <section class="h-3/4-screen w-full grid grid-cols-12  ">
        <div class="col-span-10 col-start-2 grid grid-cols-4 gap-6   content-center">
            <div
                ...
                <a href="/data-mahasiswa" class="text-center  mx-auto bg-blue-500 text-white py-1 w-20 rounded-lg">View</a>
            </div>
            <div
                class="flex flex-col justify-around h-72 border  rounded-lg shadow-md shadow-blue-400 ease-in duration-200 hover:-translate-y-2 hover:bg-blue-100 ">
                ...
                <a href="/data-admin" class="text-center  mx-auto bg-blue-500 text-white py-1 w-20 rounded-lg">View</a>
            </div>
            <div
                class="flex flex-col justify-around h-72 border  rounded-lg shadow-md shadow-blue-400 ease-in duration-200 hover:-translate-y-2 hover:bg-blue-100 ">
                ...
                <a href="/data-buku" class="text-center  mx-auto bg-blue-500 text-white py-1 w-20 rounded-lg">View</a>
            </div>
            <div
                class="flex flex-col justify-around h-72 border  rounded-lg shadow-md shadow-blue-400 ease-in duration-200 hover:-translate-y-2 hover:bg-blue-100 ">
