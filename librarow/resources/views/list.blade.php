...
@section('main')
    <section class="flex w-full mx-auto h-auto flex-wrap justify-around space-x-3  my-16">
        <div class="w-3/12 h-108 border border-red-500 flex flex-col justify-evenly">
